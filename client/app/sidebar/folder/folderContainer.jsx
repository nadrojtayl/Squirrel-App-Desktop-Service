...
var FolderContainer = (props) => (
  ...
  <div  className="easyui-draggable" style={{width:'100px',height:'100px',background:'#fafafa',border:'1px solid #ccc'}} data-options="onDrag:onDrag" onClick={() => (props.loadFolder(props.folder))}>
