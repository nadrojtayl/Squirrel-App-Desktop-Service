...
/***/ function(module, exports, __webpack_require__) {
	...
	var SidebarPresentation = function SidebarPresentation(props) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'easyui-draggable', 'data-options': 'onDrag:onDrag', style: { width: '100px', height: '100px', background: '#fafafa', border: '1px solid #ccc' } },
	    _react2.default.createElement(
	      'ul',
	      { className: 'easyui-panel', style: { display: 'inline-block', float: 'left', 'listStyleType': "none" } },
	      folders
	    )
	  );
	};
