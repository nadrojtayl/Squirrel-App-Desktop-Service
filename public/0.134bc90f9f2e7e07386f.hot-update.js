...
/***/ function(module, exports, __webpack_require__) {
	...
	var FolderPresentation = function FolderPresentation(props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'easyui-draggable', border: '5px solid red', style: { width: '100px', height: '100px', border: '5px solid red' }, 'data-options': 'onDrag:onDrag', onClick: function onClick() {
