	...
	var FileCardContainer = function (_React$Component) {
	  ...
	  _createClass(FileCardContainer, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement('div', { 'class': 'easyui-draggable', 'data-options': 'onDrag:onDrag', style: { width: '100px', height: '100px', background: '#fafafa', border: '1px solid #ccc' } });
	    }
	  }]);
